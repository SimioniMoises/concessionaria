...
<body>
    ...
    <ul class="faixa">
        ...
        <a href=form.php><button type="button" class="btn btn-primary">Consultar </button></a>
        <a href=form.php><button type="button" class="btn btn-primary">Listar </button></a>
        <a href=form.php><button type="button" class="btn btn-primary">Excluir </button></a>
